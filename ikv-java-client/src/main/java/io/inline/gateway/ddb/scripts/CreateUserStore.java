...
public class CreateUserStore {
    private final static Logger LOGGER = LogManager.getLogger(CreateUserStore.class);
    ...
    private void putItem(IKVStoreContext context) {
        Key primaryKey = Key.builder()
                .partitionValue(context.getAccountId()).sortValue(context.getStoreName()).build();
    ...
    public static void main(String[] args) {
        ...
        Common.FieldSchema primaryKeyField = Common.FieldSchema.newBuilder()
                .setName(primaryKeyFieldName)
                .setFieldType(Common.FieldType.STRING)
                .setId(0)
                .build();
        Common.FieldSchema partitioningKeyField = Common.FieldSchema.newBuilder()
