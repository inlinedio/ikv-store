...
fn test_fetch_server_configs() {
    ...
    user_supplied_cfg.stringConfigs.insert("account_id".to_string(), "testing-account-v1".to_string());
    user_supplied_cfg.stringConfigs.insert("account_passkey".to_string(), "testing-account-passkey".to_string());
    user_supplied_cfg.stringConfigs.insert("store_name".to_string(), "testing-store".to_string());
